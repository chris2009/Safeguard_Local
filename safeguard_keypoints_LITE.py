"""
🛡️ SafeGuard Vision AI - BlazePose LITE
=========================================
Modelo LITE: Más rápido, menos preciso
Ideal para: Edge devices, tiempo real
...
OUTPUT_FOLDER = r"D:\APRENDIZAJE\MAESTRIA\CICLO_III\MISTI\Project_local\safeguard_keypoints_lite"
...
def main():
    ...
    print("║" + " (Más rápido, menos preciso) ".center(60) + "║")
    print("╚" + "═"*60 + "╝")
    ...
    print("\n🚀 Extrayendo keypoints con modelo LITE...\n")
    start_time = time.time()
    
    for img_info in tqdm(all_images, desc="LITE", unit="img"):
        try:
    ...
    csv_path = os.path.join(OUTPUT_FOLDER, "keypoints_LITE.csv")
    df.to_csv(csv_path, index=False)
    
    if failed_images:
        with open(os.path.join(OUTPUT_FOLDER, "failed_LITE.txt"), 'w') as f:
    ...
    with open(os.path.join(OUTPUT_FOLDER, "summary_LITE.json"), 'w') as f:
